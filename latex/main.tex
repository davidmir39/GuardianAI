...
En el ecosistema de la banca digital contemporánea, la seguridad en las transacciones con tarjeta de crédito no es solo una necesidad técnica, sino un pilar fundamental de la confianza del usuario. El fraude financiero genera pérdidas millonarias cada año que impactan directamente en la cuenta de resultados de las entidades y erosionan la reputación del sector. 
...
El desarrollo de GuardianAI refleja un escenario realista de producto de IA, donde interactúan perfiles de modelado, ingeniería de datos, operaciones y negocio, así como un grupo de expertos en el dominio bancario conformado por desarrolladores del sistema bancario, así como de algunos técnicos encargados de la detección de fraudes y además se ha contado con la colaboración de la Brigada Central de Investigación Teconológica (BCIT) de la Policía Nacional.

El equipo bancario ha colaborado como fuente fundamental de conocimiento acerca del sistema bancario, y junto con la BCIT, ha definido lo que es un fraude bancario, además de actuar como stakeholder y cliente del sistema.

La brigada BCIT ha colaborado aportando definiciones expertas de fraude bancario, así como siendo fuente de conocimiento acerca de los métodos usados para cometer estos fraudes.
